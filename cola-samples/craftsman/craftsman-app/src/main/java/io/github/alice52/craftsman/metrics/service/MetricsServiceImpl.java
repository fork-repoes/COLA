package io.github.alice52.craftsman.metrics.service;
...
import io.github.alice52.craftsman.metrics.executor.*;
import io.github.alice52.craftsman.metrics.executor.query.ATAMetricQryExe;
...
public class MetricsServiceImpl implements MetricsServiceI {
    ...
    @Resource private RefactoringMetricAddCmdExe refactoringMetricAddCmdExe;
    @Resource private MiscMetricAddCmdExe miscMetricAddCmdExe;
    @Resource private CodeReviewMetricAddCmdExe codeReviewMetricAddCmdExe;
    @Resource private MetricDeleteCmdExe metricDeleteCmdExe;
