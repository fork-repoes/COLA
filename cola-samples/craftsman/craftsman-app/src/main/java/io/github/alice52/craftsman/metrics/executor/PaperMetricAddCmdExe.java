...
import io.github.alice52.craftsman.domain.metrics.model.techinfluence.PaperMetric;
import io.github.alice52.craftsman.domain.metrics.model.techinfluence.PaperMetricItem;
import io.github.alice52.craftsman.domain.userprofile.model.UserProfile;
import io.github.alice52.craftsman.dto.PaperMetricAddCmd;
...
public class PaperMetricAddCmdExe {
    ...
    public Response execute(PaperMetricAddCmd cmd) {
        ...
        paperMetricItem.setSubMetric(
                new PaperMetric(
                        new InfluenceMetric(new UserProfile(cmd.getPaperMetricCO().getOwnerId()))));
